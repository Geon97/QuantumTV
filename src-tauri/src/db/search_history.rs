...
#[tauri::command]
pub fn add_search_history(db: State<'_, Db>, keyword: String) -> Result<(), String> {
...
#[tauri::command]
pub fn clear_search_history(db: State<'_, Db>) -> Result<(), String> {
    db.with_conn(|conn| {
...
#[tauri::command]
pub fn delete_search_history(db: State<'_, Db>, keyword: String) -> Result<(), String> {
    db.with_conn(|conn| {
        conn.execute(
